...
<body class="bg-gray-900 text-white">
    <div class="container mx-auto p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24"> <!-- Ajuste en mb-24 para aumentar la separación -->
            <!-- Tarjeta Cursos -->
            <a href="{{ route('curso.index') }}" class="card bg-gray-800 shadow-lg rounded-xl p-8 text-white">
            ...
            <!-- Tarjeta Alumnos -->
            <a href="{{ route('alumno.index') }}" class="card bg-gray-800 shadow-lg rounded-xl p-8 text-white">
            ...
            <a href="{{ route('certificados.index') }}" class="card bg-gray-800 shadow-lg rounded-xl p-8 text-white">
     ...
     <!-- Segunda fila con una sola tarjeta centrada -->
     <div class="flex justify-center mt-20"> <!-- Ajuste en mt-20 para aumentar el espacio -->
        <a href="{{ route('consulta.index') }}" class="card bg-gray-800 shadow-lg rounded-xl p-8 text-white">
