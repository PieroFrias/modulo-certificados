    ...
    <div class="bg-white shadow-md rounded-lg p-6 max-w-6xl w-full mx-auto">
        ...
        <form action="{{ route('alumno.update', $alumno->id) }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="dni" id="dni" value="{{ old('dni', $alumno->dni) }}" maxlength="8" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" required>
            </div>
